...
export default function Header() {
    ...
    return (
        <>
            {/* Header */}
            <header className="text-white bg-black/80 p-4 fixed top-0 left-0 w-full z-50 border-b border-gray-800">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="w-32 flex justify-end lg:hidden">
                        <button
                    ...
                    <nav className="hidden lg:flex w-32 justify-end">
            ...
            {/* Connect Wallet Button (Positioned under the header, left side) */}
